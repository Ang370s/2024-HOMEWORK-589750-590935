...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		...
		assertEquals(new ArrayList<>(Collections.singletonList("nord")), new ArrayList<>(bilocale.getStanzaIniziale().getDirezioni()));
		assertEquals(new ArrayList<>(Collections.singletonList("sud")), new ArrayList<>(bilocale.getStanzaVincente().getDirezioni()));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		List<Attrezzo> attrezzi = new ArrayList<>(labirintoBuilder.getStanze().get(nomeStanza).getAttrezzi());
